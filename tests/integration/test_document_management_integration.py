...
class TestDocumentManagementIntegration:
    ...
    def test_clear_documents_with_orphaned_es_indices(self, mock_db_session):
        ...
        with (
            ...
            # Setup mocks
            mock_button.return_value = True  # User clicks confirm
    ...
    def test_synchronize_indices_removes_orphaned_chunks(self, mock_db_session):
        ...
        with patch("elasticsearch.Elasticsearch") as mock_es_class:
            ...
            mock_es.delete_by_query.assert_called()
    ...
    def test_delete_document_with_es_cleanup(self, mock_db_session, mock_document, temp_file):
        ...
        with (
            ...
            # Verify ES cleanup
            mock_es.delete.assert_called_with(index="documents", id="1", ignore=[404])
