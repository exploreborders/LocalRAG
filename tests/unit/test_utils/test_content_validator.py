...
class TestContentValidator:
    ...
    def test_is_chunk_meaningful_no_sentences(self):
        ...
        # This chunk has enough length and words but no sentence structure
        no_sentences = "word word word word word word word word word word"

        # The current logic considers this meaningful due to word count
        # Let's test with a truly meaningless chunk
