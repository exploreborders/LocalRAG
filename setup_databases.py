...
def setup_docker_databases():
    ...
    # Start databases
    if not run_command("docker-compose up -d postgres elasticsearch",
...
def setup_local_databases():
    ...
    print("   docker run -d -p 9200:9200 -p 9300:9300 -e \"discovery.type=single-node\" elasticsearch:8.11.0")
    print()
