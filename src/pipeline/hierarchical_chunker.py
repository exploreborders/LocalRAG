...
class HierarchicalChunker:
    ...
    def chunk_document(self,
        ...
        for chapter in hierarchy:
            chapter_chunks = self._chunk_chapter(
                text, chapter, hierarchy, filename
            )
    ...
    def _chunk_chapter(self,
        ...
        for section in sections:
            section_chunks = self._chunk_section(
                section, chapter_path, chapter_title,
                current_pos, chunk_index, filename
            )
    ...
    def _estimate_chapter_content(self,
                                full_text: str,
                                chapter: Dict[str, Any],
                                hierarchy: List[Dict[str, Any]]) -> str:
        """
            ...
            if current_length + word_length > self.chunk_size and current_chunk:
                ...
                if len(chunk_text) >= self.min_chunk_size:
                    chunk = self._create_chunk(
                        chunk_text, chapter_path, chapter_title,
                        start_index + len(chunks), global_pos + chunk_start,
                        filename
                    )
                    chunks.append(chunk)
