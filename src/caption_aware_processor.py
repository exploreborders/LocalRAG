...
class CaptionAwareProcessor:
    ...
    def _get_caption_context(self, lines: List[str], caption_line: int, context_window: int = 3) -> str:
        """
    ...
    def create_caption_centric_chunks(self, docling_document: DoclingDocument,
                                    metadata: Optional[Dict[str, Any]] = None) -> List[LangchainDocument]:
        """
    ...
    def _create_chunks_with_captions(self, structure: Dict[str, Any],
