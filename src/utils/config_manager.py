...
class ModelConfig:
    ...
    llm_small_model: str = "llama3.2:3b"
    
    # Vision models
    vision_model: str = "qwen2.5vl:latest"
    vision_small_model: str = "qwen2.5vl:7b"
    
    # Structure extraction models
    structure_model: str = "phi3.5:latest"
    
    # Topic classification models
    topic_model: str = "phi3.5:latest"
...
class ConfigManager:
    ...
    def validate_config(self) -> Dict[str, Any]:
        ...
        if not self.database.password and os.getenv('REQUIRE_SECURE_PASSWORDS', 'false').lower() == 'true':
            issues.append({
                'severity': 'high',
                'category': 'database',
