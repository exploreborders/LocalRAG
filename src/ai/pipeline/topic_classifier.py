...
class TopicClassifier:
    ...
    def __init__(self,
        ...
        self.topic_categories = {
            'academic': [
                'research', 'study', 'analysis', 'methodology', 'theory',
                'literature', 'publication', 'academic', 'scholarly'
            ],
            'technical': [
                'algorithm', 'implementation', 'system', 'architecture',
                'framework', 'protocol', 'standard', 'specification'
            ],
            'business': [
                'management', 'strategy', 'market', 'finance', 'economics',
                'organization', 'enterprise', 'corporate', 'industry'
            ],
            'scientific': [
                'experiment', 'data', 'measurement', 'observation',
                'hypothesis', 'validation', 'empirical', 'quantitative'
            ],
            'educational': [
                'learning', 'teaching', 'education', 'training', 'course',
                'tutorial', 'guide', 'instruction', 'curriculum'
            ]
        }
    ...
    def classify_document_topics(self,
                               text: str,
                               title: str = "",
                               existing_topics: Optional[List[str]] = None) -> Dict[str, Any]:
        """
    ...
    def _build_topic_prompt(self,
                          text: str,
                          title: str,
                          existing_topics: Optional[List[str]] = None) -> str:
    ...
    def _fallback_classification(self, text: str, title: str) -> Dict[str, Any]:
        ...
        word_freq = Counter(words)
        frequent_words = [word for word, freq in word_freq.most_common(5)
    ...
    def suggest_related_documents(self,
